...
🌟Here is the home page of Hong Kong Dey. There are few options to bring you to different sessions.
...
🌟Here is one of examples of the learning session. 
Over the left side, there are chinese word and english word of the item in the picture.
On the right side, there are description of the item, and the audio player which has the Cantonese pronunciation of the word.
...
🌟Once you finished learning on the learning sessions and want to test yourself, go back to the home page and select the multiple choice icon.
It will brings you to this page. Then, you are ready to test your self. Good Luck 💪
