...
import chat from '../../assets/icons/coming-soon2.png';
...
import HomeBackground from '../../assets/videos/HomeBg.mp4';
                    ...
                    <div className="home__desktop-background">
                        ...
                        <section className="learning-game">
                            ...
                            <div className="learning__desktop">
                                <Link to={`/learning/word/1`} className="learning-option__desktop">
